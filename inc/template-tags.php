...
if ( ! function_exists( 'twentyfifteen_entry_meta' ) ) :
	...
	function twentyfifteen_entry_meta() {
		...
		if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
			...
			printf(
				'<span class="posted-on"><span class="screen-reader-text">%1$s </span><a class="u-url" href="%2$s" rel="bookmark">%3$s</a></span>',
		...
		if ( 'post' == get_post_type() ) {
			if ( is_singular() || is_multi_author() ) {
				$author_avatar_size = apply_filters( 'twentyfifteen_author_avatar_size', 96 );
				printf(
					'<span class="byline"><span class="author h-card hcard vcard">%1$s<span class="screen-reader-text">%2$s </span><a class="p-name u-url url fn n" href="%3$s">%4$s</a></span></span>',
